...
public class MessageManager {
    ...
    private final HashMap<Class<? extends CommunicationMessage>,
            Integer> messageClassIDMap;
    private final ArrayList<CommunicationMessage> sendMessageList;
    private final List<CommunicationMessage> receivedMessageList;
    private final Set<String> checkDuplicationCache;
