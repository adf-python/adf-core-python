package adf_core_python.impl.module.complex;
            ...
            case NON_PRECOMPUTE:
                if (agentURN == AMBULANCE_TEAM) {
                    this.pathPlanning = moduleManager.getModule(
                            ...
                            "adf_core_python_core_python.impl.module.algorithm.DijkstraPathPlanning");
                    this.clustering = moduleManager.getModule(
                            "DefaultSearch.Clustering.Ambulance",
                            "adf_core_python.impl.module.algorithm.KMeansClustering");
                } else if (agentURN == FIRE_BRIGADE) {
                    this.pathPlanning = moduleManager.getModule(
                            "DefaultSearch.PathPlanning.Fire",
                            "adf_core_python.impl.module.algorithm.DijkstraPathPlanning");
                    this.clustering = moduleManager.getModule(
